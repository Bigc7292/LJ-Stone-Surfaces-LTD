...
import { MATERIALS, COLORS } from '@/lib/visualizerConstants';
import { visualizeStone, generateMaterialSwatch, ArchitecturalEngineError } from '@/services/geminiVisualizerService';
...
export const LuxeStoneVisualizer: React.FC = () => {
    ...
    return (
        <div className="bg-slate-950 text-slate-100 rounded-3xl overflow-hidden border border-slate-800/50 shadow-2xl">
            <style>{`
      ...
      `}</style>
            ...
            {/* Header */}
            <header className="border-b border-slate-800 bg-slate-900/50 backdrop-blur-md px-6 py-4 flex justify-between items-center">
                <div className="flex items-center space-x-3">
                    ...
                    <h2 className="text-xl font-bold uppercase tracking-tight">STONE<span className="text-amber-500">VISION</span></h2>
                </div>
